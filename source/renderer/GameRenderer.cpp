...
#include <glPortal/Portal.hpp>  //<-- Remove need for this and all its usages
...
GameRenderer::GameRenderer(World &w, Renderer &ren,
                           Camera *cam)
    : SubRenderer(dynamic_cast<World&>(w), ren, camera(cam))
